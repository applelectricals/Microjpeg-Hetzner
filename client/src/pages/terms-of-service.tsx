        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <CardContent className="prose prose-gray max-w-none">
            ...
            <div className="space-y-8">
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">1. Submitted Content</h2>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">2. Service Limits</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">4. Renewals and Cancellation</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">5. License and Ownership</h2>
                <p className="text-gray-300">
              ...
              <section>
                ...
                <p className="text-gray-300 mb-4">You represent and warrant that:</p>
                <ul className="list-disc pl-6 text-gray-300 space-y-2">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">9. Data Processing</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">10. Third-Party Service Providers</h2>
                <p className="text-gray-300 mb-4">
