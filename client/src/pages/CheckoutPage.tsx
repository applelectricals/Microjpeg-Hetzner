...
const PLANS = {
  starter: {
    ...
    monthly: { 
      price: 9, 
      subscriptionPlanId: 'P-5H209695PC6961949NEHOG2Q'
    },
    yearly: { 
      price: 49, 
      subscriptionPlanId: 'P-8RD90370JE5056234NEHPDGA',
      savings: 59 
    },
    features: [
  ...
  pro: {
    ...
    monthly: { 
      price: 19, 
      subscriptionPlanId: 'P-3T648163FS1399357NEHPECQ'
    },
    yearly: { 
      price: 149, 
      subscriptionPlanId: 'P-1EF84364HY329484XNEHPFMA',
      savings: 79 
    },
    features: [
      'Unlimited compressions',
  ...
  business: {
    ...
    monthly: { 
      price: 49, 
      subscriptionPlanId: 'P-5AW33365PX203061NNEHPGIY'
    },
    yearly: { 
      price: 349, 
      subscriptionPlanId: 'P-3Y884449P0365514TNEHPHDA',
      savings: 239 
    },
    features: [
      'Unlimited compressions',
...
export default function CheckoutPage() {
  ...
  // Render PayPal ONE-TIME PAYMENT button (for cards)
  useEffect(() => {
    if (!paypalLoaded) return;
