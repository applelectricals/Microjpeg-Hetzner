...
export default function CancellationPolicy() {
  useEffect(() => {
    document.title = "Cancellation & Refund Policy - Micro JPEG";
  }, []);
        ...
        <Card>
          ...
          <CardContent className="prose prose-gray max-w-none">
            ...
            <div className="space-y-8">
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">1. Subscription Plans</h2>
                
                <h3 className="text-xl font-medium text-gray-200 mb-3">Available Plans</h3>
                ...
                <h3 className="text-xl font-medium text-gray-200 mb-3">Payment Methods</h3>
                <p className="text-gray-300 mb-4">We accept payments through:</p>
              ...
              <section>
                ...
                <h3 className="text-xl font-medium text-gray-200 mb-3">How to Cancel</h3>
                <p className="text-gray-300 mb-4">You can cancel your subscription at any time through:</p>
                <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-200 mb-3">Immediate Effect</h3>
                ...
                <h3 className="text-xl font-medium text-gray-200 mb-3">No Cancellation Fees</h3>
              ...
              <section>
                ...
                <h3 className="text-xl font-medium text-gray-200 mb-3">30-Day Money-Back Guarantee</h3>
                <p className="text-gray-300 mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-200 mb-3">Refund Eligibility</h3>
                <p className="text-gray-300 mb-4">Refunds are available in the following circumstances:</p>
                <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-200 mb-3">Non-Refundable Items</h3>
                ...
                <h3 className="text-xl font-medium text-gray-200 mb-3">Refund Process</h3>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">4. Pro-rata Refunds</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">5. Billing and Payment Issues</h2>
                
                <h3 className="text-xl font-medium text-gray-200 mb-3">Failed Payments</h3>
                <p className="text-gray-300 mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-200 mb-3">Dispute Resolution</h3>
                <p className="text-gray-300">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">6. Service Credits</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">7. Enterprise and Custom Plans</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-white mb-4">8. Data Retention After Cancellation</h2>
                <p className="text-gray-300 mb-4">
              ...
              <section>
                ...
                <div className="bg-gray-800/50 p-4 border border-teal-500/30 rounded-lg">
                  <p className="text-gray-300 mb-2"><strong>Email:</strong> refunds@microjpeg.com</p>
                  <p className="text-gray-300 mb-2"><strong>Support:</strong> support@microjpeg.com</p>
                  <p className="text-gray-300 mb-2"><strong>Billing:</strong> billing@microjpeg.com</p>
                  <p className="text-gray-300"><strong>Phone:</strong> Available in your account dashboard</p>
                </div>
              </section>
            </div>
