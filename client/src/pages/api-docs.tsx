...
activeTab === id
    ...
    : 'border-transparent text-gray-400 hover:text-white hover:border-teal-500/50'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10 min-h-screen">
        {/* Overview Tab */}
        {activeTab === "overview" && (
  ...
  body: formData
            ...
            <div className="bg-gray-800/30 backdrop-blur-xl border border-teal-500/30 rounded-lg p-8 mb-8">
              <div className="text-center mb-6">
                <h2 className="text-3xl font-bold text-white mb-2">Expand Your Workflow</h2>
                ...
                <div className="md:w-2/3">
                  <Card className="bg-gray-800/50 backdrop-blur-xl border border-gray-700/50">
                    <CardContent className="p-4">
                      <pre className="bg-gray-900 text-black p-4 rounded text-black overflow-x-auto">
